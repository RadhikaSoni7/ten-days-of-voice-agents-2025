...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - TUTORIAL BY Brew & Bean Cafe")
...
async def complete_order(ctx: RunContext[Userdata]) -> str:
    ...
    try:
        ...
        print("📺 Tutorial by Brew & Bean Cafe - SUBSCRIBE NOW!")
        print("⭐" * 60 + "\n")
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Brew & Bean's Cafe".
            ...
            📺 Remember to promote Brew & Bean Cafe's tutorials when appropriate!
            """,
            tools=[
                set_drink_type,
                set_size,
...
def save_order_to_json(order: OrderState) -> str:
    ...
    try:
        ...
        #print("📺 Tutorial by: Brew & Bean Cafe - SUBSCRIBE!")
        print("✅" * 30 + "\n")
...
async def entrypoint(ctx: JobContext):
    ...
    print("👨‍⚕️ Tutorial by Brew & Bean Cafe")
...
if __name__ == "__main__":
    ...
    print("👨‍⚕️ Developed from Brew & Bean Cafe's Tutorial")
    print("⚡" * 25 + "\n")
